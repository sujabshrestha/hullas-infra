                            ...
                            <div class="col-sm-6">
                                <nav class="breadcrumb-two" aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item active"><a href="{{ route('admin.inquiry.index') }}">Inquiries</a></li>
                                    </ol>
                                </nav>
                            </div>
                            <div class="col-sm-6">
                        ...
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            @foreach($inquiries as $inquiry)
                                <tr>
                                    ...
                                    <td>{{ $inquiry->email }}<a class="badge badge-success" href="mailto:{{ $inquiry->email }}">Send Mail</a> </td>
                                    <td >
                                        {{ $inquiry->phoneNumber }}
                                    </td>
                                    <td class="text-capitalize">
                                        {{ str_replace('_', ' ', $inquiry->service)  }}
                                    </td>
                                    <td>

                                        {{-- <a href="{{ route('admin.callback.show', $inquiry->id) }}" title="Edit" class="badge badge-primary viewPopUpModal"> <i data-feather="eye"></i></a> --}}
                                        <a href="{{ route('admin.inquiry.delete', $inquiry->id) }}"  title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>
